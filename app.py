...
def form():
    if request.method == 'POST':
        ...
        result = calculate_customer_score(df)  # This will calculate the customer score and get matching companies

        # You can then pass the result to a template or handle it as needed
        return render_template('results.html', companies=result)  # Assuming you have a results.html to display the companies
